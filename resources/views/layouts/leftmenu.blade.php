...
<ul class="navigation slimmenu" id="navigation">
    ...
    <li {!! (Request::is( 'form_elements') || Request::is( 'realtime_form') || Request::is( 'form_validations') || Request::is( 'form_layouts') || Request::is( 'complex_forms')|| Request::is( 'complex_forms2') || Request::is( 'radio_checkboxes') || Request::is( 'form_editors') || Request::is( 'form_wizards') || Request::is( 'dropdowns') || Request::is( 'datepicker') ||Request::is( 'advanceddate_pickers') ||Request::is( 'x-editable') ||Request::is( 'jstree') ? 'class="menu-dropdown active"': 'class="menu-dropdown"') !!}>
        ...
        <ul class="sub-menu">
            ...
            <li {!! (Request::is( 'form_editors') || Request::is( 'form_wizards') || Request::is( 'dropdowns') || Request::is( 'datepicker') || Request::is( 'advanceddate_pickers') ||Request::is( 'x-editable') ||Request::is( 'jstree')? 'class="active"': 'class=""') !!}>
                <a href="javascript:void(0)">
    ...
    <li {!! (Request::is( 'pickers') || Request::is( 'grid_layout') || Request::is( 'tags_input') || Request::is( 'nestable_list') || Request::is( 'sweet_alert') || Request::is( 'toastr_notifications') || Request::is( 'draggable_portlets') ||Request::is( 'jstree') ||Request::is( 'transitions')? 'class="active menu-dropdown"': 'class="menu-dropdown"') !!}>
        <a href="javascript:void(0)">
        ...
        <ul class="sub-menu">
            ...
            <li {!! (Request::is( 'jstree')? 'class="active"': "") !!}>
                <a href="{{url('jstree')}}">
                    <i class="fa fa-fw ti-folder"></i> <span class="mm-text">Jstree</span>
                </a>
            </li>
    ...
    <li {!! (Request::is( 'users') || Request::is( 'edit_user') || Request::is( 'addnew_user') || Request::is( 'user_profile') || Request::is( 'deleted_users') ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        <a href="javascript:void(0) ">
        ...
        <ul class="sub-menu ">
            <li {!! (Request::is( 'users')? 'class="active "': " ") !!}>
                <a href="{{url( 'users')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Users List</span>
                </a>
            </li>
            <li {!! (Request::is( 'addnew_user')? 'class="active "': " ") !!}>
                <a href="{{url( 'addnew_user')}} ">
                    <i class="fa fa-fw ti-user "></i><span class="mm-text "> Add New User</span>
                </a>
            </li>
            <li {!! (Request::is( 'user_profile')? 'class="active "': " ") !!}>
                <a href="{{url( 'user_profile')}} ">
                    <i class="fa fa-fw ti-id-badge "></i><span class="mm-text "> View Profile</span>
                </a>
            </li>
            <li {!! (Request::is( 'deleted_users')? 'class="active "': " ") !!}>
                <a href="{{url( 'deleted_users')}} ">
                    <i class="fa fa-fw ti-trash "></i><span class="mm-text "> Deleted Users</span>
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="menu-dropdown ">
        ...
        <ul class="sub-menu ">
            <li>
                <a href="javascript:void(0) ">
                    <i class="fa fa-fw ti-control-skip-forward "></i> <span class="mm-text ">Level 1</span>
                    <span class="fa arrow "></span>
                </a>
                <ul class="sub-menu sub-submenu ">
                    <li>
                        <a href="javascript:void(0) ">
                            <i class="fa fa-fw ti-control-skip-forward "></i><span class="mm-text "> Level 2</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0) ">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu sub-submenu ">
                            <li>
                                <a href="javascript:void(0) ">
                                    <i class="fa fa-fw ti-control-skip-forward "></i> <span class="mm-text ">Level 3</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0) ">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu sub-submenu ">
                                    <li>
                                        <a href="javascript:void(0) ">
                                            <i class="fa fa-fw ti-control-skip-forward "></i><span class="mm-text "> Level 4</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0) ">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu sub-submenu ">
                                            <li>
                                                <a href="javascript:void(0) ">
                                                    <i class="fa fa-fw ti-control-skip-forward "></i> <span class="mm-text ">Level 5</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0) ">
