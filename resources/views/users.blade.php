@extends('layouts/default') {{-- Page title --}} @section('title') Users List @stop {{-- local styles --}} @section('header_styles')
<link rel="stylesheet" type="text/css" href="{{asset('vendors/datatables/css/dataTables.bootstrap.css')}}" />@stop {{-- Page Header--}} @section('page-header')
                    ...
                    <table class="table table-bordered" id="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Activated</td>
                                <td>19 weeks ago</td>
                                <td><a href="{{url('edit_user')}}"><i
                                                class="fa fa-fw ti-pencil text-primary actions_icon"
                                                title="Edit User"></i></a><a href="#" data-toggle="modal" data-target="#delete"><i
                                                class="fa fa-fw ti-close text-danger actions_icon"
                                                title="Delete User"></i>
                                        </a><a href="{{url('user_profile')}}"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning">
                            <span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Account?
                        </div>
                    </div>
